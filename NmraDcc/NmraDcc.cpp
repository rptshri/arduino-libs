...
void processMultiFunctionMessage( uint16_t Addr, uint8_t Cmd, uint8_t Data1, uint8_t Data2 )
{
  ...
  Serial.print("processMultiFunctionMessage: ") ;
  Serial.print(Addr,DEC) ;
  Serial.print(',');
  Serial.print(readCV(1),DEC) ;
  Serial.print(',');
  ...
  case 0b00100000:  // Advanced Operations 0x20
  ...
  case 0b10000000:  // Function Group 1
    if( notifyDccFunc )
	    notifyDccFunc( Addr, 1, (Cmd & 0b00011111) ) ;
    break;

  case 0b10100000:  //  Function Group 2
    if( notifyDccFunc )
	   notifyDccFunc( Addr, 2, (Cmd & 0b00011111) ) ;
    break;

  case 0b11000000:  // Feature Expansion Instruction
    if( (Cmd & 0b00011111 ) == 0b00011110)
	  notifyDccFunc( Addr, 3, Data1 ) ;    //F13-F20 Function Control
    break;
